...
export function partitionId(value: number): {
...
function entityIdString(value: string): {
    kind: PartitioningKind;
    length: number;
    value: Buffer;
} {
...
function entityIdBytes(value: Buffer): {
    kind: PartitioningKind;
    length: number;
    value: Buffer;
} {
...
function entityIdInt(value: number): {
    kind: PartitioningKind;
    length: number;
    value: Buffer;
} {
...
function entityIdUlong(value: bigint): {
    kind: PartitioningKind;
    length: number;
    value: Buffer;
} {
...
function entityIdGuid(value: string): {
    kind: PartitioningKind;
    length: number;
    value: Buffer;
} {
